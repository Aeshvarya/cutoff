...
|---|---|---|---|
| **Cutoff (fitted)** | **0.4770** | **0.0542** | **0.6950** |
| Cutoff (unfitted defaults) | 0.6484 | 0.2687 | 0.5697 |
| HLR (ACL 2016, our implementation) | 0.9688 | 0.3431 | 0.4793 |
...
number and you plan around it. Expected calibration error is **0.0249** across
520,243 reviews, and **2.7 points** three months out — which is the horizon the
...
than pulled from a chart library.
...
web/               the interface. No build step, charts hand-drawn in SVG.
